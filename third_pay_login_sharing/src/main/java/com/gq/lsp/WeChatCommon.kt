...
object WeChatCommon {
    ...
    var onLoginSuccessCallback: (userInfo: WXUserInfoData) -> Unit = {}
    var onSuccessMessageCallback: (isSuccess: Boolean, str: String) -> Unit = { _,_ ->}
    var onPayStatusCallback: (bool: Boolean, str: String, orderId: String) -> Unit = { _,_,_ ->}
    ...
    private fun getUserWxInfo(access_token: String, openid: String) {
        getRetrofit().create(TPLSApi::class.java).userWxInfo(
            ...
            override fun onResponse(call: Call<ResponseBody>, response: Response<ResponseBody>) {
                ...
                if (parseString.isJsonObject) {
                    val fromJson = GsonCommon.gson.fromJson(parseString, WXUserInfoData::class.java)
